...
class ChapterDataTest(TestCase):
    ...
    def setUp(self):
        ...
        self.chapter1 = dict(hero=self.hero_title,
                             title='Achilles', order='1', document='1.md')
        self.chapter2 = dict(hero=self.hero_title,
                             title='Agamememnon', order='2', document='2.md')
    ...
    def test_chapter_list(self):
        Chapter.objects.create(**self.chapter1)
        Chapter.objects.create(**self.chapter2)
        b = Chapter.objects.filter(hero=self.hero_title).order_by('order')
...
class ChapterViewsTest(TestCase):
    ...
    def setUp(self):
        ...
        self.chapter1 = dict(hero=self.hero_title, title='Achilles',
                             order='1', html='x', markdown='x', document='1.md')
        self.chapter2 = dict(hero=self.hero_title, title='Agamememnon',
    ...
    def test_chapter_delete_view(self):
        self.login()
        Chapter.objects.create(**self.chapter1)
        self.assertEqual(reverse('chapter_delete', args='1'),
                         '/chapter/1/delete')
